...
$name="SDLWebDiscoveryService"
$displayName="SDL Web Discovery Service"
$description="SDL Web Discovery Service"
...
$arguments += "--StartClass=com.sdl.delivery.service.WinServiceContainer"
...
$arguments += "--StopClass=com.sdl.delivery.service.WinServiceContainer"
